...
// App specific tables
export const researchReports = sqliteTable("researchReport", {
  ...
  fullReport: text("fullReport", { mode: "json" }).notNull(), // JSON stringified ResearchState
...
export const userPreferences = sqliteTable("userPreference", {
  userId: text("userId")
    .primaryKey()
    .references(() => users.id, { onDelete: "cascade" }),
  investmentStyle: text("investmentStyle"), // 'Conservative', 'Balanced', 'Aggressive'
